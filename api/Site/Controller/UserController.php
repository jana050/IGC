...
class UserController extends BaseController
{
  ...
  /**
    ...
    public function getAllByOrg()
    {
     ...
     public function getAllRoleIndex()
    {
        $role_name_index = isset($this->post["role_name_index"]) ? trim($this->post["role_name_index"]) : "";
        if (strlen($role_name_index) < 1) {
            \CustomErrorHandler::triggerInvalid("Invalid Role Name");
        }
        $role_index_value = SmartSiteSettings::getSetting($role_name_index);
