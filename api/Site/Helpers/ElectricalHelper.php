 ...
 * @author kms
 */
class ElectricalHelper extends BaseHelper
{
    ...
    {
        return $this->insertDb(self::schema, Table::ELECTRICAL, $columns, $data);
    }
    /**
     * 
     */
    ...
    {
        return $this->updateDb(self::schema, Table::ELECTRICAL, $columns, $data, $id);
    }
    /**
     * 
     */
    ...
    {
        $select = ["COUNT(title) AS electrical, MONTH(last_modified_time) AS month"];
        $from = Table::ELECTRICAL;
        ...
        foreach ($count as $elec) {
            ...
            $eleCount = intval($elec->electrical);
    ...
    */
    ...
    return array_values($electrical_count); 
    }
    ...
    //ElectricalComplaintReport
    public function ElectricalComplaintReport($start_date, $end_date)
   {
    $select = [
        "t1.title",
        "t1.description",
