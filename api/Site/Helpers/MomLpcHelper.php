 ...
 * @author kms
 */
class MomLpcHelper extends BaseHelper
{
    ...
    */
    ...
    {
        return $this->insertDb(self::schema, Table::MOM_LPC, $columns, $data);
    }
    /**
     * 
     */
    ...
    {
        return $this->updateDb(self::schema, Table::MOM_LPC, $columns, $data, $id);
    }
    /**
     * 
     */
