...
class TableHelper
{
   ...
   //
   const DOC_VIEW_COUNT  = "sd_doc_view_count";
   //
   const COMMITTEE_IIBCC = "sd_commitee_iibcc";
   //
   const BUDGET_TYPE = "sd_budget_type";
   // 
   const COMMITTEE_LPC = "sd_commitee_lpc";
   //
   const COMMITTEE_LPC_SUB = "sd_commitee_lpc_sub";
   //
   const MOM_IIBCC = "sd_mom_iibcc";
   //
   const MOM_LPC = "sd_mom_lpc";
   //
