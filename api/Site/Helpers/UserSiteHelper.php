 ...
 * @author kms
 */
class UserSiteHelper extends BaseHelper
{
    const schema = [
   ...
   const FILE_NAME = "file";
    ...
    {
        return $this->insertDb(self::schema, Table::HELPER, $columns, $data);
    }
    /**
     * 
     */
    ...
    {
        return $this->updateDb(self::schema, Table::HELPER, $columns, $data, $id);
    }
    /**
     * 
     */
